...
<AccordionGroup>
  ...
  <Accordion title="Runtime and storage subpaths">
    ...
    | `plugin-sdk/gateway-runtime` | Gateway client, operator approval client helpers, verified plugin approval resolver, event-loop-ready client start helper, gateway CLI RPC, gateway protocol errors, and channel-status patch helpers |
