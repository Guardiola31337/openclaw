...
import { requireApprovalRecord, type OperatorApprovalRecord } from "./operator-approval-store.js";
import { resolveApprovalsCoveredBySessionGrant } from "./plugin-external-verification-grant-coverage.js";
import {
